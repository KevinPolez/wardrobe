...
class UserManager implements UserProviderInterface
{
	...
	/** @var string */
	protected $userClass = '\Wardrobe\Entities\User';
	...
	{
		return ($class === 'Wardrobe\Entities\User') || is_subclass_of($class, 'Wardrobe\Entities\User');
	}
	...
	public function findOneById($id)
	{
		...
		$repo = $this->app['orm.em']->getRepository('\Wardrobe\Entities\User');
	...
	public function findCount()
	{
		...
		->createQuery('SELECT COUNT(user) FROM \Wardrobe\Entities\User user')
